  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center p-4">
      <div className="text-center max-w-md">
        ...
        <h1 className="text-2xl sm:text-3xl text-white font-bold">Escolher Plano</h1>
        <p className="text-slate-400 mt-3">
          Esta funcionalidade está em desenvolvimento. Em breve você poderá escolher seu plano e realizar o pagamento.
        </p>
        <Button 
